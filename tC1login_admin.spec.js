...
describe('TC1 login admin', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('TC1 login admin', async function() {
    ...
    //or: await driver.findElement(By.css("input[id='email']")).sendKeys("admin@proxyqb.com")
